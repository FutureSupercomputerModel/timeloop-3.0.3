...
for buffer_size in [2,20,100]:
    ...
    with open(output_file, "w+") as f:
        ...
        p = subprocess.Popen(['python3', 'sample-fusion.py', f'sample-hierarchy-no-dram-{buffer_size}MB-sram.yaml', f'sample-hierarchy.yaml', str(buffer_size), result_dir, stats_file], stdout=f)
        processes.append(p)
